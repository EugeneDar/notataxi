...
TODO узнать а в качестве кэшей используем внешние штуки или на той же машинке? Если на той же, то еще и перерисовать схему.

Основная БД -- БД заказов. Её схема: TODO.

Для кэшей должна использоваться TODO. Она является LRU.
