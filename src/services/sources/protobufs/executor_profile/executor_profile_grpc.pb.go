...
const (
	ExecutorProfileService_GetExecutorProfile_FullMethodName = "/executor_profile.ExecutorProfileService/GetExecutorProfile"
)
...
func (c *executorProfileServiceClient) GetExecutorProfile(ctx context.Context, in *ExecutorProfileRequest, opts ...grpc.CallOption) (*ExecutorProfileResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExecutorProfileService_GetExecutorProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedExecutorProfileServiceServer must be embedded to have
...
func (UnimplementedExecutorProfileServiceServer) testEmbeddedByValue() {}
...
func RegisterExecutorProfileServiceServer(s grpc.ServiceRegistrar, srv ExecutorProfileServiceServer) {
	// If the following call pancis, it indicates UnimplementedExecutorProfileServiceServer was
...
func _ExecutorProfileService_GetExecutorProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExecutorProfileService_GetExecutorProfile_FullMethodName,
	}
