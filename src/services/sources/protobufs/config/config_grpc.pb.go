...
func (c *configServiceClient) GetConfig(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ConfigResponse, error) {
...
func (UnimplementedConfigServiceServer) GetConfig(context.Context, *empty.Empty) (*ConfigResponse, error) {
